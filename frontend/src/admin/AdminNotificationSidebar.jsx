...
export default function AdminNotificationSidebar({ isOpen, onClose }) {
  ...
  const handleMarkAsRead = async (notifId) => {
    try {
      await fetch(`${API_BASE_URL}/admin/notifications/${notifId}/read/`, {
        method: "POST",
  ...
  const handleDelete = async (notifId) => {
    try {
      await fetch(`${API_BASE_URL}/admin/notifications/${notifId}/`, {
        method: "DELETE",
        headers: { ...getAuthHeaders() },
      });
  ...
  const handleClearAll = async () => {
    try {
      await fetch(`${API_BASE_URL}/admin/notifications/clear/`, {
        method: "POST",
        headers: { ...getAuthHeaders() },
      });
      setNotifications([]);
  ...
  return (
    <>
      ...
      <aside
        className={`admin-notification-sidebar ${isOpen ? "open" : ""}`}
        role="complementary"
  ...
  return [
    {
      ...
      message: "Cinema Palace has registered as new vendor",
      type: "info",
      is_read: false,
    ...
    {
      id: 3,
      title: "Vendor Support Request",
      message: "QFX Cinema submitted support ticket",
      type: "warning",
      is_read: true,
